...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tayyab Naveed - Laravel</title>
    ...
    <body class="antialiased">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">Upload Spreadsheet</a>
                                </div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <form id="excelFileUploadForm">
                                        <input accept=".xlsx" id="excelFileInput" name="excel_file" type="file"/>
                                        <br/>
                                        <span class="mt-4 upload-status"></span>
        ...
        <script>
            window.addEventListener('load', (e)=>{
                document.getElementById('excelFileUploadForm').addEventListener('submit', (e)=>{
                    e.preventDefault();
                    global.uploadDynamicExcelFile(e);
                })
            });
        </script>
    </body>
